/*
 * ak_ui_colorStyleDefaultBright.cpp
 *
...
#define _alternateBackWindow "alternate-background-color:#a8a8a8;"
#define _fore "color:#000000;"
#define _foreTab "color:#000000;"
#define _selectionFore "selection-color:#000000;"
#define _selectionBack "selection-background-color:qlineargradient(x1: 0, y1: 0, x2: 1, y2: 1, stop: 0 #50b050, stop : 1 #c0f0c0);"
#define _focusFore "color:#ffffff;"
#define _focusBack "background-color:qlineargradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #80a0e0, stop : 1 #a0c0f0);"
#define _selectedFore "color:#000000;"
#define _selectedBack "background-color:qlineargradient(x1: 0, y1: 0, x2: 1, y2: 1, stop: 0 #50b050, stop : 1 #c0f0c0);"
...
QString ak::ui::colorStyleDefaultBright::getStylesheet(
	...
	catch (const ak::Exception & e) { throw ak::Exception(e, "ak::ui::colorStyleDefaultBright::getStylesheet(stylableObjects)"); }
	catch (const std::exception & e) { throw ak::Exception(e.what(), "ak::ui::colorStyleDefaultBright::getStylesheet(stylableObjects)"); }
	catch (...) { throw ak::Exception("Unknown error", "ak::ui::colorStyleDefaultBright::getStylesheet(stylableObjects)"); }
...
QString ak::ui::colorStyleDefaultBright::getStylesheet(
	...
	catch (const ak::Exception & e) { throw ak::Exception(e, "ak::ui::colorStyleDefaultBright::getStylesheet(stylableObject)"); }
	catch (const std::exception & e) { throw ak::Exception(e.what(), "ak::ui::colorStyleDefaultBright::getStylesheet(stylableObject)"); }
	catch (...) { throw ak::Exception("Unknown error", "ak::ui::colorStyleDefaultBright::getStylesheet(stylableObject)"); }
}
