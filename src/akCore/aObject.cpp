...
ak::aObject::aObject(objectType _type, UID _uid)//, int _references)
	: m_uid(_uid), m_references(0), m_objectType(_type), m_alias(""), m_parentObject(nullptr), m_owner(nullptr)
{}
...
QString ak::aObject::alias(void) const { return m_alias; }
